...
# --- Session 2 homework: extended EDA + reusable pipeline
python scripts/run_session2.py            # Parts 1-5: figures fig16-25, tables, key numbers (~20 s)
python scripts/build_session2_pdf.py      # render reports/session2_report.md, enforce 4 pages
...
│   ├── eda2.py                        # Session 2 Parts 1-2: metadata association, colour analysis
│   ├── pipeline.py                    # Session 2 Parts 3-4: process_image/_batch, BatchLoader
│   ├── viz.py                         # Session 2 Part 5: image grids, class balance, batch summary
...
│   ├── run_session2.py                # Session 2: every figure, table and number
│   ├── build_session2_pdf.py          # Session 2 report -> PDF (checks the 4-page limit)
...
│   ├── test_session2.py               # Session 2: preprocessing, bad-file skipping, loader, stats
...
│   ├── figures/                       # Session 1 figures (fig01-15), Session 2 (fig16-25)
...
│   ├── session2_report.md             # Session 2 report source (renders on GitHub)
│   ├── Session2_MILK10k_EDA_Pipeline_Stanislaus_Lattorff.pdf   # ← SESSION 2 PDF DELIVERABLE
│   └── session2_summary.md            # Session 2 numbers, generated by run_session2.py
│
├── docs/
...
- [x] **Session 2 homework** — metadata–label association, colour analysis per class, reusable preprocessing, loader and visualiser
